...
class NegativeWagerTest : public Test{
  public:
    NegativeWagerTest(){
      setName("NegativeWagerTest");
      addMessage(std::make_shared<WagerMessage>("Game", "-100"));
      addResponseMessage(std::make_shared<WagerResponseMessage>("Player", "Rejected"));
    }
