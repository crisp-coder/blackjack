...
class InsuranceTestDeck : public Deck{
  public:
    InsuranceTestDeck(){
      max_size_ = 52; 
      init();
    ...
    void init(){
      ...
      // Dealer has BJ, Player loses hand, Player Accepted Ins Bet
      ...
      // Dealer has BJ, Player loses hand, Player Rejected Ins Bet
      ...
      // Dealer does not have BJ, Player Stands and wins. Player Accepted Ins Bet
      ...
      // Dealer does not have BJ, Player Stands and Wins, Player Rejected Ins Bet
      ...
      cards_.push_back(std::make_shared<Card>(Card(Suit::Hearts, Rank::Three)));
